...
export default class Edito extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    request
      .post("http://192.168.1.100/Emag/api/ClientConfigEditor/CreateNewClientConfigEditor")
      ...
      .send({
        ...
        EditorPhoto: this.state.EditorPhoto,
    ...
    return (
      <div className="myDiv" >
        <form onSubmit={this.handleSubmit}>
          ...
          <div className="row">
            <div className="col">
              <label className="file-label" htmlFor="backgroundImage">Editor Photo</label>
              <div className="input-group">
                <div className="custom-file">
                  <input type="file" className="custom-file-input" required id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" />
                  <label className="custom-file-label" htmlFor="inputGroupFile04">Choose file</label>
            ...
            <div className="col">
              ...
              <input onChange={this.handleChange} name="Designation" required type="text" className="form-control" placeholder="Enter background image url" />
            </div>
          </div>
          <div className="row">
            <div className="col-4">
